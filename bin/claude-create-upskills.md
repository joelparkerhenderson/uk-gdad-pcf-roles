# Claude create upskills

Context: United Kingdom (UK) Government Digital and Data (GDAD) Profession Capability Framework (PCF)

Goal: create files in directory ./upskills/ that correspond to files in directory ./summaries/.

For each empty file in ./upskills/**/*.md 

1. Read the corresponding file in ./summaries/

2. Research a list of relevant job training links for learning and professional development.
...
3. Save output in the file ./upskills/**/*.md
